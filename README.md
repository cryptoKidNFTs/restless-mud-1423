...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/restless-mud-1423)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/restless-mud-1423
```

A live public deployment of this template is available at [https://restless-mud-1423.templates.workers.dev](https://restless-mud-1423.templates.workers.dev)
